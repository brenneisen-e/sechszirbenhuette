...
export function AdaptiveImage({
  ...
  const imageProps = {
    ...
    priority,
    // Explicitly set loading="lazy" when not priority for better lazy loading
    loading: priority ? undefined : ('lazy' as const),
    onClick,
    placeholder: 'blur' as const,
    blurDataURL: 'data:image/jpeg;base64,',
    sizes: sizes || '100vw',
  };
