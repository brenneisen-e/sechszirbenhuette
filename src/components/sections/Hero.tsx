        ...
        <div className="flex-1 flex items-center justify-center pt-16">
          ...
          >
            <motion.p
              ...
              className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl mb-2 text-white drop-shadow-lg"
            ...
            <motion.p
              ...
              className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-white drop-shadow-lg"
              style={{ fontFamily: 'BrittanySignature, cursive' }}
            >
