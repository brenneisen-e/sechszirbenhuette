...
const defaultTexts: Record<string, ContentText> = {
  ...
  ferienhaus_grundriss_description: createText('ferienhaus_grundriss_description', 'Unsere Hütte bietet auf ca. 85 m² Wohnfläche Platz für bis zu 5 Personen. Im Erdgeschoss befinden sich die Küche, der gemütliche Wohnbereich mit Schwedenofen, sowie der Wellnessbereich mit Sauna und Ruheraum. Im Obergeschoss liegen die Schlafzimmer mit 2 Doppelbetten und 1 Einzelbett.', 'ferienhaus', 'body'),
