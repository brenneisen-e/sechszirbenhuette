...
const defaultTexts: Record<string, ContentText> = {
  ...
  hero_title: {
    ...
    font_family: null, font_size: null, color: null, section: 'hero', text_type: 'heading', updated_at: ''
  },
  hero_subtitle: {
  ...
  hero_description: {
    ...
    font_family: null, font_size: null, color: null, section: 'hero', text_type: 'body', updated_at: ''
  },

  // IntroText Section
  introtext_main_heading: {
    id: 0, text_key: 'introtext_main_heading', content: 'Uriges Ferienhaus am Falkert - mit Sauna und Ruheraum',
    font_family: null, font_size: null, color: null, section: 'introtext', text_type: 'heading', updated_at: ''
  },
  introtext_heading_1: {
  ...
  introtext_text_1: {
    ...
    font_family: null, font_size: null, color: null, section: 'introtext', text_type: 'body', updated_at: ''
  },
  introtext_heading_2: {
  ...
  ferienhaus_title: {
    ...
    font_family: null, font_size: null, color: null, section: 'ferienhaus', text_type: 'heading', updated_at: ''
  },
  ferienhaus_subtitle: {
    ...
    font_family: null, font_size: null, color: null, section: 'ferienhaus', text_type: 'body', updated_at: ''
  },

  // Umgebung Section
  umgebung_title: {
    id: 0, text_key: 'umgebung_title', content: 'Umgebung & Aktivitäten',
    font_family: null, font_size: null, color: null, section: 'umgebung', text_type: 'heading', updated_at: ''
  },
  umgebung_subtitle: {
    id: 0, text_key: 'umgebung_subtitle', content: 'Erleben Sie die Vielfalt der Nockberge',
    font_family: null, font_size: null, color: null, section: 'umgebung', text_type: 'body', updated_at: ''
  },

  // Buchung Section
  buchung_title: {
    id: 0, text_key: 'buchung_title', content: 'Buchung & Preise',
    font_family: null, font_size: null, color: null, section: 'buchung', text_type: 'heading', updated_at: ''
  },
  buchung_subtitle: {
    id: 0, text_key: 'buchung_subtitle', content: 'Buchen Sie Ihren Traumurlaub in der Sechszirbenhütte',
    font_family: null, font_size: null, color: null, section: 'buchung', text_type: 'body', updated_at: ''
  },

  // Bewertungen Section
  bewertungen_title: {
    id: 0, text_key: 'bewertungen_title', content: 'Das sagen unsere Gäste',
    font_family: null, font_size: null, color: null, section: 'bewertungen', text_type: 'heading', updated_at: ''
  },
  bewertungen_subtitle: {
    id: 0, text_key: 'bewertungen_subtitle', content: 'Erfahrungen und Bewertungen von Urlaubern',
    font_family: null, font_size: null, color: null, section: 'bewertungen', text_type: 'body', updated_at: ''
  },
};
